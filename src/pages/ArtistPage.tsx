...
function PaginationControls({ page, total, pageSize, setPage }: { page: number, total: number, pageSize: number, setPage: (p: number) => void }) {
  ...
  return (
    <div className="flex items-center justify-center gap-1.5 mt-10 py-6 border-t border-border/40">
      <Button 
        variant="outline" 
        size="icon" 
        className="h-9 w-9" 
